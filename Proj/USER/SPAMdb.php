...
function readSPAM(){
    ...
    $info= $this-> DB  -> query("SELECT S.Titre,S.Cause,S.SType,S.Description,S.SDate,S.Stime,S.ChefID,C.Nom AS fnameCHEF,C.Prenom as lnameCHEF,S.RefProd,P.Categorie  
    From SPAM S 
