...
<nav class="mainNav sb-topnav navbar navbar-expand navbar-dark bg-dark ">
            <!-- Navbar Brand-->
            <a class=" text-muted navbar-brand ps-3 " href="index.html">Chef Depot area</a>
...
<div class="position-sticky bg-dark" >
        ...
        <div class="navpart mx-2">
        <ul class="navbar-nav">
        <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="showsec(0)">Home</a></li>
            <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="" >Setting </a></li>
   
        
        </div>
        <div class="navpart mx-2 ">
        <span class="text-muted  " ><b>Product</b> 
        </span>
        <ul class="Navg  navbar-nav">
        <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="showsec(0)">Product info</a></li>
        
        </ul>
        </div>
        <div class="navpart mx-2 ">
        <span class="text-muted  " ><b>Orders</b> 
        </span>
        <ul class="Navg  navbar-nav">
        <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="showsec(1)" >Create an order</a> </li>
        <li class="nav-item nv-it">  <a class="nav-link " href="#">Show orders history</a></li>
        
        </ul>
        </div>
        <div class="navpart mx-2 ">
        <span class="sb-sidenav-menu-heading text-muted cmd"><b>SPAM PRODUCT</b> 
        </span>
        <ul class="Navg  navbar-nav">
        <li class="nav-item nv-it " ><a class="nav-link " href="#" onclick="showsec(2)"> SPAMbox</a></li> 
        </ul>
        </div>
        <div class="navpart mx-2">
        ...
        <ul class="text-muted my-1 navbar-nav">
            ...
            <li class="nav-item"> <b> phone : </b> <?= $_SESSION['Contact'];?></li>
