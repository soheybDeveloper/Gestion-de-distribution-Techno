...
<div class="position-sticky bg-dark" >
        ...
        <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="showsec(0)">Home</a></li>
            <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="" >User info </a></li>
        ...
        <li class="nav-item nv-it"><a class="nav-link " href="Product.php" >Product info</a></li>
        
        </ul>
        </div>
        <div class="navpart  ">
        <span class="text-muted  " ><b>Gestion des Commande</b> 
        </span>
        <ul class="Navg  navbar-nav">
        <li class="nav-item nv-it"><a class="nav-link " href="#" onclick="showsec(2)" >Create Command</a> </li>
        <li class="nav-item nv-it">  <a class="nav-link " href="#">Show Command history</a></li>
        ...
        <ul class="Navg  navbar-nav">
        <li class="nav-item nv-it " ><a class="nav-link " href="#" onclick="showsec(3)">> SPAM</a></li> 
        </ul>
        </div>
        </div>
</aside>
