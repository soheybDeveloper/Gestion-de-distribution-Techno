...
<?php 
    ...
    $db1= $db ->prepare("SELECT * FROM admin WHERE  Nom_utilisateurA = ? and Mot_de_passeA = ?");
...
.then((willOUT) => {
         ...
         <?php
           ...
           break;
           case 1 :      $INFO =$db1 ->fetch();
           $_SESSION['idAdmin']=$INFO["AdminID"];      
           $_SESSION['FirstName']=$INFO["Nom"];   
           $_SESSION['LastName']=$INFO["Prenom"];   
           $_SESSION['Birth']=$INFO["DateNaiss"];   
           $_SESSION['email']=$INFO["Email"];
           $_SESSION['RecDate']=$INFO["Date_de_recrutement"];       
             header("location:Adminarea.php?id=".  $_SESSION['idAdmin']) ; 
...
<h1 class="display-5 mt-4"><b>Welcome admin ! </b></h1>
